...
// (GET /dashboards/configuration) et état du mode personnalisation.
// Les widgets y lisent leurs seuils ; la grille y lit la composition par
// profil et les préférences individuelles (masquage, ordre).
...
// Seuils d'un widget donné, tableau vide si aucun n'est configuré.
