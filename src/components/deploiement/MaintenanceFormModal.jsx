  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        {versionGeree && (
          <FormField label="Version apportée" hint={versionsListe.length ? 'Optionnel : devient la version courante de la licence' : 'Aucune version sélectionnable (produit sans version ou maintenance arrêtée)'}>
